...
public class NegativFiltrRedactorNewsTK49Test {
    ...
    @Test
    @Story("Фильтрация новостей без указания категории, но с указанием только даты от, во вкладке Новости мобильного приложения (Негативный)")
    public void negativFiltrRedactorNewsTK49Test() {
