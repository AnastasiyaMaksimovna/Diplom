...
public class NegativPasswordSpezSimvolTest {
    @Rule
    public ActivityScenarioRule<AppActivity> mActivityScenarioRule =
            new ActivityScenarioRule<>(AppActivity.class);

    @Test
    @Story("Поле Пароль состоит из спецсимволов, при авторизации в мобильном приложении(Негативный)")
    public void negativPasswordSpezSimvolTest() {
