...
public class NegativLoginNumberTest {
    ...
    @Test
    @Story("Поле Логин состоит из цифр, при авторизации в мобильном приложении (Негативный)")
    public void negativLoginNumberTest() {
