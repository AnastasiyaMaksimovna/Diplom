...
public class NegativLoginSpezSimvolTest {
    ...
    @Test
    @Story("Поле Логин состоит из спецсимволов, при авторизации в мобильном приложении (Негативный)")
    public void negativLoginSpezSimvolTest() {
