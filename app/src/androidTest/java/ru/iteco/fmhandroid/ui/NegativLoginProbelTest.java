...
public class NegativLoginProbelTest {
    ...
    @Test
    @Story("Поле Логин состоит из пробелов, при авторизации в мобильном приложении (Негативный)")
    public void negativLoginProbelTest() {
