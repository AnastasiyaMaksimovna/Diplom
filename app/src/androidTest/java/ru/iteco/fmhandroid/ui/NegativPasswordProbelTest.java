...
public class NegativPasswordProbelTest {
    ...
    @Test
    @Story("Поле Пароль состоит из пробелов, при авторизации в мобильном приложении (Негативный)")
    public void negativPasswordProbelTest() {
