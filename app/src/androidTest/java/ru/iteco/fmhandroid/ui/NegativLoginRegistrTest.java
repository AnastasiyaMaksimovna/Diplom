...
public class NegativLoginRegistrTest {
    ...
    @Test
    @Story("Поле Логин состоит из букв разного регистра, при авторизации в мобильном приложении (Негативный)")
    public void negativLoginRegistrTest() {
