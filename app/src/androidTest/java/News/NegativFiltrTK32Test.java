...
public class NegativFiltrTK32Test {
    ...
    @Test
    @Story("Фильтрация новостей с указанием категории, но с указанием только даты от, во вкладке Новости мобильного приложения (Негативный)")
    public void negativFiltrTK32Test() {
