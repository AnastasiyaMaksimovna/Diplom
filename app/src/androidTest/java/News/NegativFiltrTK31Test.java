...
public class NegativFiltrTK31Test {
    ...
    @Test
    @Story("Фильтрация новостей без указания категории, но с указанием только даты до, во вкладке Новости мобильного приложения (Негативный)")
    public void negativFiltrTK31Test() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.message), withText("Неверно указан период"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Неверно указан период")));
    }
