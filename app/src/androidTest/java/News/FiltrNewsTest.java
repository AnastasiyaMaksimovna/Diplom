...
public class FiltrNewsTest {
    ...
    @Test
    @Story("Работоспособность кнопки  фильтрации  новостей мобильного приложения (Позитивный)")
    public void filtrNewsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.filter_news_title_text_view), withText("Фильтровать новости"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Фильтровать новости")));
    }
