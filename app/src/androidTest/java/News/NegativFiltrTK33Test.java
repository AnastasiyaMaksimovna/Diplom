...
public class NegativFiltrTK33Test {
    ...
    @Test
    @Story("Фильтрация новостей с указанием категории, но с указанием только даты до, во вкладке Новости мобильного приложения (Негативный)")
    public void negativFiltrTK33Test() {
